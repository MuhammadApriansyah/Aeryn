...
async def broadcast_notifications():
    ...
    try:
        from aeryn_core.platform.notification_system import get_notification_manager
...
async def handle_websocket_command(command: str, data: dict) -> dict:
    ...
    try:
        if command == "get_stats":
            ...
            from aeryn_core.platform.notification_system import get_notification_manager, Notification
            mgr = get_notification_manager()
            notif = Notification(
