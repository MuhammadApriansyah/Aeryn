...
class ToolRuntime:
    ...
    async def _fs_read(self, params: Dict) -> ToolResult:
        ...
        from aeryn_core.safety.security_hardening import validate_path, SAFE_READ_DIRS
    ...
    async def _fs_write(self, params: Dict) -> ToolResult:
        ...
        # Security: validate path
        from aeryn_core.safety.security_hardening import validate_path, SAFE_WRITE_DIRS
