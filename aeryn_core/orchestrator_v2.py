...
from aeryn_core.vault import AerynVault, VaultEntry, LAYER_WIKI, ensure_dirs
from aeryn_core.graph import VaultGraph
from aeryn_core.adapters import get_active_adapter, render_adapter_context
from aeryn_core.persona_engine import load_persona, PersonaEngine
...
class ReasoningModule:
    ...
    def compile_system_prompt(self, goal: str, session_id: str, 
        ...
        # 2. CoT rule
        from aeryn_core.reasoning_style import COGNITIVE_CHAIN_OF_THOUGHT_RULE
        ...
        from aeryn_core.cerewet_mode import cerewet_context_block, CEREWET_RULES
    ...
    def select_tools(self, goal: str, available_tools: list) -> list:
        ...
        from aeryn_core.dynamic_schema import build_dynamic_schemas
    ...
    def build_next_token_hint(self, session_id: str) -> str:
        ...
        from aeryn_core.reasoning_style import build_next_token_hint
...
class MemoryModule:
    ...
    def record_interaction(self, user_id: str, role: str, content: str):
        ...
        if role == "user":
            # Extract commitments
            from aeryn_core.cerewet_mode import detect_commitment, add_commitment
