...
class TestReasoningModule:
    ...
    def test_init_creates_persona(self):
        from aeryn_core.orchestrator_v2 import ReasoningModule
        rm = ReasoningModule()
...
class TestMemoryModule:
    ...
    def test_init_creates_social_memory(self):
        from aeryn_core.orchestrator_v2 import MemoryModule
        mm = MemoryModule()
...
class TestGovernanceModule:
    ...
    def test_init_creates_safety_and_limiter(self):
        from aeryn_core.orchestrator_v2 import GovernanceModule
        gm = GovernanceModule()
...
class TestCognitiveOrchestrator:
    ...
    def test_init_creates_all_modules(self):
        from aeryn_core.orchestrator_v2 import CognitiveOrchestrator
...
class TestOrchestratorSingleton:
    ...
    def test_get_orchestrator_returns_instance(self):
        from aeryn_core.orchestrator_v2 import get_orchestrator, CognitiveOrchestrator
        # Reset singleton
        import aeryn_core.orchestrator_v2 as mod
